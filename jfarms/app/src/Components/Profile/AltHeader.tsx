...
function NameandPosition(name?: string, position?: string) {
  ...
  return (
    <div className="flex flex-col xs:text-center lg:text-left">
      ...
      <h2 className=" font-medium text-slate-500">{_position}</h2>
    </div>
  );
}
  ...
  return (
    <div className="flex justify-evenly gap-2 outline outline-purple-500 p-1 w-fit self-end">
      <a
        ...
        target="_blank"
        rel="noopener"
        className=" relative aspect-square w-7 focus:outline-orange-400 outline outline-2 rounded-sm p-1 outline-sky-700"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 50"
          className=" hover:fill-orange-400 hover:scale-110"
        >
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        className="font-semibold hover:bg-green-200 hover:scale-105 focus:outline-orange-400 outline outline-2 outline-sky-700 rounded-sm px-1"
      >
...
function NoMansLand() {
  return (
    <div className=" grid grid-cols-2 gap-5">
      ...
      <div className=" outline outline-green-600">
        <h3 className=" font-semibold text-slate-500 text-lg">Salary range</h3>
        <p> $0 - $0</p>
      </div>
      <div className=" outline outline-green-600">
...
export default function AltHeader() {
  ...
  return (
    <div className="bg-slate-100 rounded-md shadow-lg my-2 px-2 w-80 xs:w-11/12 flex lg:flex-row xs:flex-col justify-between">
      ...
      <div className="outline outline-blue-700 flex flex-col gap-8 xs:m-0 lg:m-2 p-2 lg:w-5/12">
        ...
        <svg
          ...
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          className=" aspect-square w-8 self-end fill-blue-800 outline outline-red-600"
        >
